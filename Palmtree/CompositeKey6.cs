...
namespace Palmtree
{
    ...
    /// 6番目のクラスです。
    /// </typeparam>
    public class CompositeKey<KEY1_T, KEY2_T, KEY3_T, KEY4_T, KEY5_T, KEY6_T>
        : IEquatable<CompositeKey<KEY1_T, KEY2_T, KEY3_T, KEY4_T, KEY5_T, KEY6_T>>
    {
        #region コンストラクタ
        ...
        /// 6番目のクラスのオブジェクトです。
        /// </param>
        public CompositeKey(KEY1_T key1, KEY2_T key2, KEY3_T key3, KEY4_T key4, KEY5_T key5, KEY6_T key6)
        {
            Key1 = key1;
            Key2 = key2;
            Key3 = key3;
        ...
        public override bool Equals(object o)
        {
            if (o == null || GetType() != o.GetType())
                return (false);
            return (Equals((CompositeKey<KEY1_T, KEY2_T, KEY3_T, KEY4_T, KEY5_T, KEY6_T>)o));
        }
        ...
        {
            return (Key1.GetHashCode() ^ Key2.GetHashCode() ^ Key3.GetHashCode() ^ Key4.GetHashCode() ^ Key5.GetHashCode() ^ Key6.GetHashCode());
        }
        ...
        /// 6番目のクラスのオブジェクトです。
        /// </summary>
        public KEY6_T Key6 { get; private set; }

        #endregion

        #region IEquatable<CompositeKey<KEY1_T, KEY2_T, KEY3_T, KEY4_T, KEY5_T, KEY6_T>> のメンバ
