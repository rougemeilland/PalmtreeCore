...
namespace Palmtree
{
    ...
    /// 3番目のクラスです。
    /// </typeparam>
    public class CompositeKey<KEY1_T, KEY2_T, KEY3_T>
        : IEquatable<CompositeKey<KEY1_T, KEY2_T, KEY3_T>>
    {
        #region コンストラクタ
        ...
        /// 3番目のクラスのオブジェクトです。
        /// </param>
        public CompositeKey(KEY1_T key1, KEY2_T key2, KEY3_T key3)
        {
            Key1 = key1;
            Key2 = key2;
            Key3 = key3;
        ...
        public override bool Equals(object o)
        {
            if (o == null || GetType() != o.GetType())
                return (false);
            return (Equals((CompositeKey<KEY1_T, KEY2_T, KEY3_T>)o));
        }
        ...
        #region IEquatable<CompositeKey<KEY1_T, KEY2_T, KEY3_T>> のメンバ
        ...
        /// オブジェクトが等しければtrue、そうではないのならfalseです。
        /// </returns>
        public bool Equals(CompositeKey<KEY1_T, KEY2_T, KEY3_T> o)
        {
            if (o == null || GetType() != o.GetType())
                return (false);
