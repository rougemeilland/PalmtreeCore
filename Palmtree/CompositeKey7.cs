...
namespace Palmtree
{
    ...
    /// 7番目のクラスです。
    /// </typeparam>
    public class CompositeKey<KEY1_T, KEY2_T, KEY3_T, KEY4_T, KEY5_T, KEY6_T, KEY7_T>
        : IEquatable<CompositeKey<KEY1_T, KEY2_T, KEY3_T, KEY4_T, KEY5_T, KEY6_T, KEY7_T>>
    {
        #region コンストラクタ
        ...
        /// 7番目のクラスのオブジェクトです。
        /// </param>
        public CompositeKey(KEY1_T key1, KEY2_T key2, KEY3_T key3, KEY4_T key4, KEY5_T key5, KEY6_T key6, KEY7_T key7)
        {
            Key1 = key1;
            Key2 = key2;
            Key3 = key3;
        ...
        public override bool Equals(object o)
        {
            if (o == null || GetType() != o.GetType())
                return (false);
            return (Equals((CompositeKey<KEY1_T, KEY2_T, KEY3_T, KEY4_T, KEY5_T, KEY6_T, KEY7_T>)o));
        }
        ...
        /// 7番目のクラスのオブジェクトです。
        /// </summary>
        public KEY7_T Key7 { get; private set; }

        #endregion

        #region IEquatable<CompositeKey<KEY1_T, KEY2_T, KEY3_T, KEY4_T, KEY5_T, KEY6_T, KEY7_T>> のメンバ
